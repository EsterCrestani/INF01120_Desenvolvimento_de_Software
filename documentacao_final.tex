...
\begin{tabular}{lp{11.5cm}}
  ...
  + & Aumenta o volume da voz atual em 10 (limitado a 100). \\
...
\begin{itemize}
  \item \textbf{Atributo Base \texttt{ocupa\_beat: bool}:} Determina se o token bloqueia a execução da voz até a próxima batida temporal (como notas e pausas) ou se é processado instantaneamente antes do avanço temporal (como mudanças de instrumento, volume ou oitava).
  ...
  \item \textbf{Hierarquia de Subclasses:}
    \begin{itemize}
      ...
      \item \texttt{TokenVolumeUp}: Aumenta o volume dinâmico da voz atual em 10, limitado ao volume máximo de 100.
